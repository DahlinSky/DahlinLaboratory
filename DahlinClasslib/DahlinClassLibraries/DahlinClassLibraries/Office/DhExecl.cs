...
namespace DahlinClassLibraries.Office
{
    /// <summary>
    /// NOPI Excel电子表格帮助类
    /// </summary>
    public class DhExecl
    {
                ...
                for (int i = (HeaderRowIndex + 1); i <= sheet.LastRowNum; i++)
                {
                    try
                    {
                        ...
                        for (int j = row.FirstCellNum; j <= cellCount; j++)
                        {
                            ...
                            {
                                SlLog.Write(SlTraceType.Log, SlException.ToString(exception));
                            }
                        }
        ...
        public static void InsertSheet(string outputFile, string sheetname, DataTable dt)
        {
            ...
            {
                SlLog.Write(SlTraceType.Log, SlException.ToString(ex));
                throw;
            }
